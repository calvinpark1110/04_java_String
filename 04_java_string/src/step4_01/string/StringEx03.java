...
public class StringEx03 {
	...
	public static void main(String[] args) {
		...
		// 3-1) substring(index1, index2) : index1부터 index2미만까지(마지막은 포함하지 않는다.)
		...
		System.out.println(rsArr.length);	// 3
		System.out.println(rsArr[0]);		// java
		System.out.println(rsArr[1]);		// jsp
		System.out.println(rsArr[2]);		// spring
		System.out.println();
